...
from src.tools.handoff import handoff_to_bounty
...
async def make_guardian_agent():
    ...
    mcp_tools = await load_mcp_tools(agent_name=["guardian"])

    swarm_tools = [handoff_to_bounty]
    ...
    agent = create_react_agent(
        ...
        store=store,
        name="Guardian",
        prompt=load_prompt("guardian", "swarm"),
    )
    return agent
