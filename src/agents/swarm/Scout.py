...
from src.tools.handoff import handoff_to_bounty, handoff_to_guardian
...
async def make_scout_agent():
    ...
    mcp_tools = await load_mcp_tools(agent_name=["scout"])
    ...
    agent = create_react_agent(
        ...
        store=store,
        name="Scout",
        prompt=load_prompt("scout", "swarm")
    )
    return agent
