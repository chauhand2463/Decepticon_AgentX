...
def validate_environment() -> Dict[str, Any]:
    ...
    validation_result = {"valid": True, "errors": [], "warnings": [], "config": config}
    ...
    if not available_keys:
        ...
        validation_result["warnings"].append(
            f"Available API keys: {', '.join(available_keys)}"
        )

    try:
        from src.graphs.swarm import create_dynamic_swarm  # noqa: F401
        from src.utils.message import extract_message_content  # noqa: F401
