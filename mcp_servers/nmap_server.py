        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "ports": {
                        "type": "string",
                        "description": "Ports to scan (e.g. '80,443,22')",
                    },
                    "timeout": {"type": "integer", "default": 300},
                },
                "required": ["target", "ports"],
        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "ports": {
                        "type": "string",
                        "description": "Open ports to assist OS detection",
                    },
            ...
            for host in parsed.get("hosts", []):
                for port in host.get("ports", []):
                    for script in port.get("scripts", []):
                        if (
                            "VULNERABLE" in script.get("output", "").upper()
                            or "CVE" in script.get("output", "").upper()
                        ):
